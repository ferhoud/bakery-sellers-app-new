...
export default async function handler(req, res) {
  try {
    ...
    if (analysis.employee_user_id) {
      ...
      existingLatestAt = existing?.[0]?.created_at || null;
    }
    ...
    return json(res, 200, {
      ...
      preview: {
        ...
        existing_latest_created_at: existingLatestAt,
      },
    });
  } catch (e) {
    return json(res, 500, { ok: false, error: e?.message || "Analyse de correction impossible." });
  }
}
